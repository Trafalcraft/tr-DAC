...
public class CreateSection {
	...
	public static void create() {
		...
		file.set("Arene_Inexistante", "cette arène n'existe pas ou est mal configurée");
		file.set("No_Configure_Ingame", "vous ne pouvez faire cela sur une arène en cours");
		file.set("No_configure_ingame_2", "vous ne pouvez faire cela pendant une game");
		...
		file.set("plongeoir_config", "le plongeoir a bien été enregistré");
		file.set("lobby_event_config", "le lobby d'event a bien été enregistré");
		file.set("pos1_config", "la pos 1 a bien été enregisté");
		file.set("pos2_config", "la pos 2 a bien été enregisté");
		file.set("entrer_nombre", "vous devez entrer un nombre");
		file.set("config_mod", "le mode de cette arène a bien été enregistré");
		...
		file.set("saut_rater", "#name a raté son saut");
		file.set("reussi_dac", "#name a réussi un dé à coudre");
		file.set("reussi_saut", "#name a réussi son saut");
		file.set("leave_win", "la partie est terminée, il n'y a plus assez de joueurs pour continuer");
		...
		file.set("pas_confirmer", "il n'a donc pas réussi à confirmer");
		file.set("doit_confirmer", "#name doit donc confirmer");
		file.set("plusieurs_gagnants", "les gagnants sont :");
		file.set("tour", "c est le tour de: #name");
		file.set("temps_restant", "il vous reste #temps seconde(s) pour sauter");
		file.set("trop_attendu", "#name a trop attendu pour sauter");
		file.set("pannel_action", "cette arène n'est pas en jeu vous ne pouvez donc pas y faire d'action");
		file.set("leave", "#name a quité la partie");
